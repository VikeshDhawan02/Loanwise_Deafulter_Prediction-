...
st.set_page_config(page_title="Loanwise Default Prediction App", layout="centered")

st.title("Loanwise Defaulter Prediction Project")

st.markdown("""
Welcome to the Loanwise Default Prediction application. This project aims to predict whether a loan applicant is likely to default on their loan based on various financial and personal attributes.
...
* **Technology Stack**:
    ...
    * **Machine Learning**: Python with the LightGBM library for model training and prediction, using one-hot encoded features and a `StandardScaler` for preprocessing.
